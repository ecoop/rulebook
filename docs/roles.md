...
This matches the classic authN / authZ split. a sibling app and another app can layer their own role models on top of the same `guest-auth` without either project's roles bleeding into the shared library.
