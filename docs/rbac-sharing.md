# RBAC sharing — guest-auth, Rulebook, a sibling app, another app
...
## Replicate in a sibling app (port, don't share yet)
...
## Extract — once a sibling app is the 2nd consumer (rule of three)
